# ItemID autogenerated from Terraria.ID
...
class ItemIDSets:
    ...
    IsCrafted = factory.create_int_set(-1, new int[0])
    IsCraftedCorruption = factory.create_int_set(-1, new int[0])
    IsCraftedCrimson = factory.create_int_set(-1, new int[0])
    ...
    StaffMinionSlotsRequired = factory.create_int_set(-1, 1, new int[0])
