...
class CombatText(SyncPacket):
    ...
    def __init__(self, pos: Vec2 | None = None, color: Rgb | None = None, combat_text: NetString | None = None):
        self.pos = pos or Vec2(0.0, 0.0)
        self.color = color or Rgb(0, 0, 0)
        self.combat_text = combat_text or NetString()

    def read(self, reader: Reader):
        self.pos = Vec2.read(reader)
        self.color = Rgb.read(reader)
        self.combat_text = NetString.read(reader)
